...
import { ownerAc, memberAc, adminAc, defaultAc, defaultRoles, defaultStatements } from '../../plugins/organization/access/index.mjs';
...
const organizationClient = Object.assign(
  (options) => {
...
export { InferServerPlugin, adminClient, anonymousClient, apiKeyClient, customSessionClient, emailOTPClient, genericOAuthClient, getPasskeyActions, inferAdditionalFields, jwtClient, magicLinkClient, multiSessionClient, oidcClient, oneTapClient, organizationClient, passkeyClient, phoneNumberClient, ssoClient, usernameClient };
