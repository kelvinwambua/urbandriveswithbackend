...
const organizationClient = Object.assign(
  ...
  {
    defaultStatements: plugins_organization_access_index.defaultStatements,
    defaultRoles: plugins_organization_access_index.defaultRoles,
    defaultAc: plugins_organization_access_index.defaultAc,
    ownerAc: plugins_organization_access_index.ownerAc,
    adminAc: plugins_organization_access_index.adminAc,
    memberAc: plugins_organization_access_index.memberAc
  }
);
